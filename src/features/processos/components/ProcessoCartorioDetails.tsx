...
type ProcessoCartorioDetailsProps = {
...
export function ProcessoCartorioDetails({
  processo,
  actions,
  ...
  return (
    <section className="p-10 bg-card flex-col mb-5 border border-primary/15 rounded flex gap-4 shadow-sm">
      ...
      <div className="flex flex-wrap gap-3 my-2">
        ...
        <p className="p-2">Enviado por: <strong>{processo.cartorio.nome}</strong></p>
        <p className="p-2">Destino: <strong>{processo.setor.nome}</strong></p>
      </div>
      ...
      <div>
        ...
        <Textarea value={processo.observacao} className="resize-none h-[120px] w-full" readOnly />
      </div>
