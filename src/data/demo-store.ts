...
const initialState = (): DemoState => ({
  ...
  processosPrefeitura: [
    ...
    {
      id: 3,
      num_processo: "PREF-2026-003",
      texto: "Solicitação encerrada para aprovação de remembramento de lotes.",
      ano: "2026",
      criado_em: "2026-03-18T12:00:00.000Z",
      prazo: "2026-04-30T12:00:00.000Z",
      ativo: false,
      status: Status.RESPONDIDO_COM_ATRASO,
      conclusao: "Processo encerrado com alvará anexado após resposta enviada fora do prazo.",
      setor: setorUrbano,
      cartorio: cartorioCentro,
      tipo: tipoRemembramento,
      atividade: atividadeRegularizacao,
      lote_vinculado: [demoLotes[0], demoLotes[1]],
      descricao_lotes: [
        {
          id: "desc-lote-3",
          lote: "08/21",
      ...
      resposta: {
        id: "resposta-lote-1",
        observacao: "Matrícula unificada localizada e conferida no acervo do cartório.",
        alvara: "Alvará demo 2026/014",
        processo_id: 3,
        descricao: [
          {
            id: "resposta-desc-1",
            lote: "08/21",
            matricula: "92.114",
            data_registro: "02/05/2026",
            transcricao: "Registro unificado conforme solicitação municipal.",
            aprovacao_id: "",
            descricao_id: "desc-lote-3",
          },
        ],
      },
      respostaPessoa: null,
  ...
  processosCartorio: [
    ...
    {
      id: 2,
      num_processo: "CART-2026-002",
      observacao: "Processo concluído de comunicação de alteração cadastral.",
      ano: "2026",
      criado_em: "2026-04-22T12:00:00.000Z",
      ativo: false,
      setor: setorTributos,
      cartorio: cartorioNorte,
      tipo: tipoOutro,
      ...
      descricao_pessoas: [
        {
          id: "desc-cart-pessoa-1",
          nome: "Ana Martins",
          cpf: "111.111.111-11",
          telefone: "(11) 98888-1111",
          email: "ana@example.com",
          processo_prefeitura_id: null,
          processo_cartorio_id: 2,
        },
      ],
    },
  ],
